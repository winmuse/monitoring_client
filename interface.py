...
header = canvas.create_text(300.0, 90.0, text="Hostname:", fill="#ECE8EF", font=("Roboto-Bold", int(13.0)))
hostname = tkinter.Entry(root, bg="white", fg="black", font=("Roboto", 14))
hostname.place(x=400, y=80)

header = canvas.create_text(300.0, 120.0, text="UserName:", fill="#ECE8EF", font=("Roboto-Bold", int(13.0)))
username = tkinter.Entry(root, bg="white", fg="black", font=("Roboto", 14))
username.place(x=400, y=110)
